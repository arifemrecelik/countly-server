...
window.starView = countlyView.extend({
    ...
    rating: "",
    ratingFilter: {
        comments: { platform: "", version: "", rating: "", widget: "" },
        ratings: { platform: "", version: "", widget: "" }
    },
    localizeStars: [
        "star.one-star",
        "star.two-star",
    ...
    feedbackWidget: {
        ...
        popup_comment_callout:
            jQuery.i18n.map["feedback.popup-comment-callout"],
    ...
    loadPlatformData: function() {
        var self = this;
        $(".platform-list").html(
            '<div data-value="All Platforms" class="platform-option item" data-localize="star.all-platforms">' +
                jQuery.i18n.map["star.all-platforms"] +
                "</div>"
        );
        ...
        $(".platform-option").on("click", function() {
            ...
            $("#ratings_version_" + self._tab + " .text").html(
                '<div class="placeholder" data-localize="feedback.select-version">' +
                    jQuery.i18n.map["feedback.select-version"] +
                    "</div>"
            );
    ...
    loadWidgetData: function() {
        $(".widget-list").html(
            '<div data-value="All Widgets" class="widget-option item" data-localize="star.all-widgets">' +
                jQuery.i18n.map["star.all-widgets"] +
                "</div>"
        );
        for (var i = 0; i < this.templateData.widget.length; i++) {
            $(".widget-list").append(
                '<div data-value="' +
                    this.templateData.widget[i]._id +
                    '" class="widget-option item" data-localize="">' +
                    this.templateData.widget[i].popup_header_text +
                    "</div>"
            );
        }
    },
    ...
    resetFilterBox: function(keepOpen) {
        ...
        if (values.rating === "") {
            ...
            $("#ratings_rating_" + this._tab + " .text").html(
                '<div class="placeholder" data-localize="feedback.select-rating">' +
                    jQuery.i18n.map["feedback.select-rating"] +
                    "</div>"
            );
        } else {
            $("#ratings_rating_" + this._tab).clySelectSetSelection(
                values.rating,
                jQuery.i18n.map[this.localizeStars[parseInt(values.rating) - 1]]
            );
        }

        if (values.platform === "") {
            $("#ratings_platform_" + this._tab).clySelectSetSelection("", "");
            $("#ratings_platform_" + this._tab + " .text").html(
                '<div class="placeholder" data-localize="feedback.select-platform">' +
                    jQuery.i18n.map["feedback.select-platform"] +
                    "</div>"
            );
        } else {
            $("#ratings_platform_" + this._tab).clySelectSetSelection(
        ...
        if (values.version === "") {
            ...
            $("#ratings_version_" + this._tab + " .text").html(
                '<div class="placeholder" data-localize="feedback.select-version">' +
                    jQuery.i18n.map["feedback.select-version"] +
                    "</div>"
            );
        ...
        if (values.widget === "") {
            ...
            $("#ratings_widget_" + this._tab + " .text").html(
                '<div class="placeholder" data-localize="feedback.select-widget">' +
                    jQuery.i18n.map["feedback.select-widget"] +
                    "</div>"
            );
        } else {
            for (var i = 0; i < this.templateData.widget.length; i++) {
                if (this.templateData.widget[i]._id === values.widget) {
                    $("#ratings_widget_" + self._tab).clySelectSetSelection(
                        values.widget,
                        this.templateData.widget[i].popup_header_text
                    );
                }
    ...
    addScriptsForFilter: function() {
        ...
        $(".remove-star-rating-filter").on("click", function() {
            if (self._tab === "comments") {
                ...
                $("#rating-selector a").text(
                    jQuery.i18n.map["star.all-ratings"]
                );
                $.when(
                    starRatingPlugin.requestFeedbackData(
                        self.ratingFilter.comments
        ...
        $(".apply-star-rating-filter").on("click", function() {
            ...
            var rating = $(
                "#ratings_rating_" + self._tab
            ).clySelectGetSelection();
            var version = $(
                "#ratings_version_" + self._tab
            ).clySelectGetSelection();
            var platform = $(
                "#ratings_platform_" + self._tab
            ).clySelectGetSelection();
            var widget = $(
                "#ratings_widget_" + self._tab
            ).clySelectGetSelection();

            var have_filter = false;
            //rating
            if (self._tab === "comments") {
                if (rating && rating !== "All Ratings TEST" && rating !== "") {
                    selectText.push(
                        $("#ratings_rating_" + self._tab)
                            .find(".select-inner .text")
                            .html()
                    );
            ...
            if (version && version !== "All Versions" && version !== "") {
                selectText.push(
                    jQuery.i18n.map["version_history.version"] +
                        " " +
                        $("#ratings_version_" + self._tab)
                            .find(".select-inner .text")
                            .html()
    ...
    loadRatingData: function() {
        ...
        this.templateData.rating_options.reverse().forEach(function(rating) {
            $(".rating-list").append(
                '<div data-value="' +
                    rating.val +
                    '" class="rating-option item" data-localize="">' +
                    rating.title +
                    "</div>"
            );
        });
        $(".rating-list").prepend(
            '<div data-value="All Ratings TEST" class="rating-option item" data-localize="star.all-ratings">' +
                jQuery.i18n.map["star.all-ratings"] +
                "</div>"
        );
    },
    ...
    loadVersionData: function() {
        ...
        $(".version-list").html(
            '<div data-value="All Versions" class="version-option item" data-localize="star.all-app-versions">' +
                jQuery.i18n.map["star.all-app-versions"] +
                "</div>"
        );
        for (
            var versionIndex = 0;
            versionIndex < versioinList.length;
            versionIndex++
        ) {
    ...
    matchPlatformVersion: function(documentName) {
        ...
        if (this.ratingFilter.ratings.platform === "") {
            ...
            regexString +=
                this.ratingFilter.ratings.platform.toString().toUpperCase() +
                "(\\*\\*)";
        }
        if (this.ratingFilter.ratings.version === "") {
            ...
            regexString +=
                this.ratingFilter.ratings.version.toString() + "(\\*\\*)[1-5]";
        }
        if (this.ratingFilter.ratings.widget !== "") {
            regexString +=
                "(\\*\\*)" + this.ratingFilter.ratings.widget.toString();
        }
    ...
    getPeriodArray: function() {
        ...
        if (parseInt(periodObject.numberOfDays) === 1) {
            ...
            periodArray = [];
            for (
                var i = periodObject.periodMin;
                i <= periodObject.periodMax;
                i++
            ) {
    ...
    calCumulativeData: function() {
            ...
            if (
                ...
                for (var rating in result[year][month][day]) {
                    if (this.matchPlatformVersion(rating)) {
                        ...
                        this.cumulativeData[rank - 1].count +=
                            result[year][month][day][rating].c;
        ...
        this.cumulativeData.forEach(function(star) {
            var tmpPercent =
                sum === 0 ? 0 : ((star.count / sum) * 100).toFixed(1);
            star.percent =
                "<div class='percent-bar' style='width:" +
                2 * tmpPercent +
                "px;'></div>" +
                tmpPercent +
                "%";
    ...
    renderCumulativeTable: function() {
        ...
        $("#tableOne").dataTable(
            $.extend({}, $.fn.dataTable.defaults, tableData)
        );
    },
    ...
    iconGenerator: function(times) {
        ...
        var typeName =
            '<a style="font-size: 1px; display:none;">' + starName + "</a>";
        if (times && times > 0) {
            result +=
                '<span><img class="little-feedback-icon" src="star-rating/images/star-rating/' +
                (times - 1) +
                '_color.svg"></span><span class="star-rating-icon-title">' +
                rating_strings[times - 1] +
                "</span>";
        }
        result += typeName;
        return result;
    ...
    calTimeSeriesData: function() {
        ...
        if (
            ...
            moment(periodArray[0], "YYYY.M.D").isoWeekYear() === currentYear
        ) {
            dateFormat = "D MMM";
        }
        var rows = {};
        ...
        for (var i = 0; i < periodArray.length; i++) {
            ...
            var LocalDateDisplayName = moment(
                periodArray[i],
                "YYYY.M.D"
            ).format(dateFormat);
            ...
            if (
                ...
                for (var rating in result[year][month][day]) {
                    if (this.matchPlatformVersion(rating)) {
                        var rank = rating.split("**")[2];
                        rows[LocalDateDisplayName]["star" + rank] +=
                            result[year][month][day][rating].c;
                        seriesChart["star" + rank] +=
                            result[year][month][day][rating].c;
                    }
                }
            }
    ...
    renderTimeSeriesChart: function() {
        ...
        if (
            period === "yesterday" ||
            period === "hour" ||
            countlyCommon.getPeriodObj().numberOfDays === 1
        ) {
            bucket = "daily";
            overrideBucket = true;
        }
        ...
        if (self._tab === "ratings") {
            return countlyCommon.drawTimeGraph(
                renderData,
                "#dashboard-graph",
                bucket,
                overrideBucket
    ...
    renderCommentsTable: function(isRefresh) {
        ...
        if (isRefresh) {
            CountlyHelpers.refreshTable(
                ...
                this.templateData.commentsData
            );
        } else {
            var columnsDefine = [
                {
                    ...
                    mRender: function(d, type) {
                        if (type === "display") {
                            var ratings = [
                                "<span class='in-table-smiley-wrapper'><img src='star-rating/images/star-rating/1_color.svg' class='table-detail-rating-img'></span><span class='in-table-smiley-text-wrapper'>Very dissatisfied</span>",
                                "<span class='in-table-smiley-wrapper'><img src='star-rating/images/star-rating/2_color.svg' class='table-detail-rating-img'></span><span class='in-table-smiley-text-wrapper'>Somewhat dissatisfied</span>",
                                "<span class='in-table-smiley-wrapper'><img src='star-rating/images/star-rating/3_color.svg' class='table-detail-rating-img'></span><span class='in-table-smiley-text-wrapper'>Neither satisfied nor dissatisfied</span>",
                                "<span class='in-table-smiley-wrapper'><img src='star-rating/images/star-rating/3_color.svg' class='table-detail-rating-img'></span><span class='in-table-smiley-text-wrapper'>Somewhat satisfied</span>",
                                "<span class='in-table-smiley-wrapper'><img src='images/star-rating/4_color.svg' class='table-detail-rating-img'></span><span class='in-table-smiley-text-wrapper'>Very satisfied</span>"
                            ];
                            return ratings[d - 1];
                        }
                        return d;
            ...
            $("#tableThree").dataTable(
                $.extend({}, $.fn.dataTable.defaults, {
                    ...
                    bFilter: true,
                    sAjaxSource:
                        countlyCommon.API_PARTS.data.r +
                        "/feedback/data?app_id=" +
                        countlyCommon.ACTIVE_APP_ID,
                    fnServerData: function(sSource, aoData, fnCallback) {
                        if (
                            self.ratingFilter.comments.rating &&
                            self.ratingFilter.comments.rating !== ""
                        ) {
                            sSource +=
                                "&rating=" + self.ratingFilter.comments.rating;
                        }
                        if (
                            self.ratingFilter.comments.version &&
                            self.ratingFilter.comments.version !== ""
                        ) {
                            sSource +=
                                "&version=" +
                        ...
                        if (
                            self.ratingFilter.comments.platform &&
                            self.ratingFilter.comments.platform !== ""
                        ) {
                            sSource +=
                                "&platform=" +
                        ...
                        if (
                            self.ratingFilter.comments.widget &&
                            self.ratingFilter.comments.widget !== ""
                        ) {
                            sSource +=
                                "&widget_id=" +
    ...
    renderFeedbacksTable: function(isRefresh) {
        ...
        if (isRefresh) {
            ...
            var columnsDefine = [
                {
                    mData: function(row) {
                        return (
                            row.popup_header_text +
                            '<br><span class="feedback-widget-id">(Widget ID: ' +
                            row._id +
                            ")</span>"
                        );
                    },
                ...
                },
                {
                    mData: function(row) {
                        if (
                            !(
                                countlyGlobal.member.admin_of &&
                                countlyGlobal.member.admin_of.indexOf(
                                    countlyCommon.ACTIVE_APP_ID
                                ) !== -1
                            ) &&
                            ...
                            if (row.is_active === "true") {
                                input +=
                                    '<input type="checkbox" id="widget-status-' +
                                    row._id +
                                    '"" class="on-off-switch-checkbox" checked>';
                            } else {
                                input +=
                                    '<input type="checkbox" id="widget-status-' +
                                    row._id +
                            ...
                            input +=
                                '<label class="on-off-switch-label  widget-edit-status" data-id="' +
                                row._id +
                                '" for="plugin-' +
                                row._id +
                                '"></label>';
                        ...
                        if (row.target_page === "all") {
                            ...
                            row.target_pages.forEach(function(page) {
                                if (row.target_pages.indexOf(page) < 5) {
                                    target_pages +=
                                        "<div class='feedback-widget-target-page-item'>" +
                                        page +
                                        "</div>";
                                } else if (
                                    row.target_pages.indexOf(page) === 5
                                ) {
                                    target_pages +=
                                        "<div class='feedback-widget-target-page-item'>And " +
                                        (row.target_pages.length - 5) +
                                        " more...</div>";
                                }
                            });
            ...
            columnsDefine.push({
                mData: function(row) {
                    if (
                        ...
                        return (
                            "<div class='feedback-options-item options-item'>" +
                            "<div class='edit' data-id='" +
                            row._id +
                            "'></div>" +
                            "<div class='edit-menu rating-feedback-menu' id='" +
                            row._id +
                            "'>" +
                            "<div data-clipboard-text='" +
                            row._id +
                            "' class='copy-widget-id item'" +
                            " data-id='" +
                            row._id +
                            "'" +
                            "><i class='fa fa-clipboard'></i>" +
                            jQuery.i18n.map["common.copy-id"] +
                            "</div>" +
                            "<div class='show-instructions item' data-id='" +
                            row._id +
                            "'" +
                            "><i class='fa fa-eye'></i>" +
                            jQuery.i18n.map["feedback.show-instructions"] +
                            "</div>" +
                            "<div class='edit-widget item'" +
                            " data-id='" +
                            row._id +
                            "'" +
                            "><i class='fa fa-pencil'></i>" +
                            jQuery.i18n.map["feedback.edit"] +
                            "</div>" +
                            "<div class='delete-widget item'" +
                            " data-id='" +
                            row._id +
                            "'" +
                            "><i class='fa fa-trash'></i>" +
                            jQuery.i18n.map["feedback.delete"] +
                            "</div>" +
                            "</div>" +
                            "</div>"
                        );
            ...
            this.widgetTable = $("#tableFour").dataTable(
                $.extend({}, $.fn.dataTable.defaults, {
    ...
    renderFeedbackDrawer: function() {
        ...
        if (this.step === 3) {
            $("#countly-feedback-next-step").text(
                jQuery.i18n.map["feedback.complete"]
            );
            ...
            $(".feedback-preview-title").text(
                jQuery.i18n.map["feedback.preview"]
            );
        } else if (this.step === 2) {
            tippy(".show-tooltip", {
                theme: "custom",
            ...
            $("#countly-feedback-next-step").text(
                jQuery.i18n.map["feedback.next-step"]
            );
            $("#countly-feedback-back-step").css({
                display: "block"
            });
            ...
            $(".feedback-preview-title").text(
                jQuery.i18n.map["feedback.trigger-button-preview"]
            );
            $(".feedback-preview-footer").css({
                display: "none"
            });
            ...
            $(".feedback-preview-title").text(
                jQuery.i18n.map["feedback.popup-preview"]
            );
            $(".feedback-preview-footer").css({
                display: "block"
            });
        ...
        for (var slice in $(".feedback-create-side-header-slice")) {
            if (counter < 3) {
                headerSlices.push(
                    $(".feedback-create-side-header-slice")[slice]
                );
                counter++;
            }
        }
        ...
        $("#feedback-step" + this.step + "-title").addClass(
    ...
    renderCommon: function(isRefresh) {
        ...
        if (!isRefresh) {
            ...
            $("body")
                .off("click", ".options-item .edit")
                .on("click", ".options-item .edit", function() {
                    var id = $(this).data("id");
                    $(".edit-menu")
                        .splice(0, $(".edit-menu").length)
            ...
            $("body")
                .off("click", ".options-item .show-instructions")
                .on("click", ".options-item .show-instructions", function() {
                    $("#overlay").fadeIn();
                    $("#widgets-array").html($(this).data("id"));
                    if (
                        countlyGlobal.apps[store.get("countly_active_app")]
                            .type === "web"
                    ) {
                        $("#feedback-web-integration").css({
                            display: "block"
                        });
                        $(".feedback-copy-code").attr(
                            "data-clipboard-text",
                            "Countly.q.push(['enable_feedback',{'widgets':['" +
                                $(this).data("id") +
                                "']}]);"
                        );
                    } else {
            ...
            $(".colorpicker").colorpicker({
                ...
                select: function(event, color) {
                    self.feedbackWidget.trigger_font_color = $(
                        "#feedback-font-color"
                    ).val();
                    self.feedbackWidget.trigger_bg_color = $(
                        "#feedback-button-color"
                    ).val();
                    $("#feedback_color_preview_1").css({
                        "background-color": processColorString(
                            self.feedbackWidget.trigger_bg_color
                        )
                    });
                    $("#feedback-button-color").val(
                        self.feedbackWidget.trigger_bg_color
                    );
                    ...
                    $("#feedback-sticker-on-window").css({
                        ...
                        color: processColorString(
                            self.feedbackWidget.trigger_font_color
                        )
                    });

                    path1.style.fill = processColorString(
                        self.feedbackWidget.trigger_font_color
                    );
                    var id = $(this).attr("id");
                    ...
                    $(".rangeslider").slider(
                        "value",
                        100 - Math.round(a * 100)
                    );
                    var rgba =
                        "rgba(" +
                        Math.round(color.rgb.r * 256) +
                        "," +
                        Math.round(color.rgb.g * 256) +
                        "," +
                        Math.round(color.rgb.b * 256) +
                        "," +
                        color.a +
                        ")";
            ...
            $("body")
                .find("tbody")
                .off("click", ".widget-edit-status")
                .on("click", ".widget-edit-status", function() {
                    var id = $(this).data("id");
                    starRatingPlugin.requestSingleWidget(
                        $(this).data("id"),
                        function(widget) {
                            self.feedbackWidget = widget;
                            if (
                                $("#widget-status-" + id).attr("checked") ===
                                "checked"
                            ) {
                                $("#widget-status-" + id).removeAttr("checked");
                                self.feedbackWidget.is_active = false;
                            } else {
                                $("#widget-status-" + id).attr(
                                    "checked",
                                    "checked"
                                );
                            ...
                            starRatingPlugin.editFeedbackWidget(
                                self.feedbackWidget,
                                function(result, status) {
                                    if (status === 200) {
                                        $(".cly-drawer").removeClass("open");
                                        var feedebackResult = self
                                            .feedbackWidget.is_active
                                            ? "enabled"
                                            : "disabled";
                                        CountlyHelpers.notify({
                                            type: "green",
                                        ...
                                        CountlyHelpers.notify({
                                            ...
                                            title:
                                                jQuery.i18n.map[
                                                    "feedback.somethings-went-wrong"
                                                ],
                                            delay: 3000,
                                            message:
                                                jQuery.i18n.map[
                                                    "feedback.update-fail-message"
                                                ]
                                        });
                                    }
                                }
            ...
            $("#feedback-page-selector").selectize({
                ...
                create: function(input) {
                    ...
                    if (typeof self.feedbackWidget.target_pages === "string") {
                        JSON.parse(self.feedbackWidget.target_pages).forEach(
                            function(p) {
                                if (p === input) {
                                    isExist = true;
                                }
                        ...
                        if (!isExist) {
                            JSON.parse(self.feedbackWidget.target_pages).push(
                                input
                            );
                        }
                        return {
            ...
            $("body")
                ...
                .on("click", ".delete-widget", function() {
                    ...
                    CountlyHelpers.confirm(
                        jQuery.i18n.map["feedback.delete-a-widget-description"],
                        "popStyleGreen",
                        function(result) {
                            if (result) {
                                starRatingPlugin.removeFeedbackWidget(
                                    targetId,
                                    $("#popupCheckbox").attr("checked"),
                                    function(response, xhrStatus) {
                                        if (xhrStatus === 200) {
                                            CountlyHelpers.notify({
                                                type: "green",
                                                delay: 3000,
                                                message:
                                                    "Feedback widget removed successfully."
                                            });
                                            self.renderFeedbacksTable(true);
                                        } else {
                                            CountlyHelpers.notify({
                                                ...
                                                delay: 3000,
                                                message:
                                                    "Feedback widget couldn't removed."
                                            });
                                        }
                                    }
                                );
                        ...
                        [
                            ...
                            jQuery.i18n.map["feedback.yes-delete-widget"]
                        ],
                        {
            ...
            $("body")
                .off("click", ".copy-widget-id")
                .on("click", ".copy-widget-id", function() {
                    $(".edit-menu").css({
                        display: "none"
                    });
                    CountlyHelpers.notify({
            ...
            $("#selected-pages").on("click", function() {
                ...
                self.feedbackWidget.target_pages.forEach(function(target_page) {
                    ...
                    $("#feedback-page-selector")[0].selectize.addItem(
                        target_page
                    );
                });
            });
            $("body")
                .off("click", ".star-rating-tab-item")
                .on("click", ".star-rating-tab-item", function() {
                    var tabs = [];
                    var counter = 0;
                    ...
                    if (self._tab === "ratings" || self._tab === "comments") {
                        $("#" + $(this).data("target") + " .widget-header")
                            .first()
                            .append($("#date-selector"));
                        $("#" + self._tab + " .filter-selector-wrapper")
                            .first()
                            .append($(".star-rating-selector-form"));
                        self.resetFilterBox();
                    }
                    app.noHistory(
                        "#/analytics/star-rating/" + $(this).data("target")
                    );
                    $(".feedback-fields").css({ display: "none" });
                    $("#feedback-" + $(this).data("target") + "-tab").css({
                        display: "block"
                    });
            ...
            var renderFeedbackWidgetModal = function(isCreate) {
                $("#feedback-popup-header-text").val(
                    isCreate ? "" : self.feedbackWidget.popup_header_text
                );
                $("#feedback-popup-comment-text").val(
                    isCreate ? "" : self.feedbackWidget.popup_comment_callout
                );
                $("#feedback-popup-email-text").val(
                    isCreate ? "" : self.feedbackWidget.popup_email_callout
                );
                $("#feedback-popup-button-text").val(
                    isCreate ? "" : self.feedbackWidget.popup_button_callout
                );
                $("#feedback-popup-thanks-text").val(
                    isCreate ? "" : self.feedbackWidget.popup_thanks_message
                );
                $("#feedback-trigger-text").val(
                    isCreate ? "" : self.feedbackWidget.trigger_button_text
                );

                $("#counter-for-feedback-popup-header-text").html(
                    $("#feedback-popup-header-text").val().length + "/45"
                );
                $("#counter-for-feedback-popup-comment-text").html(
                    $("#feedback-popup-comment-text").val().length + "/25"
                );
                $("#counter-for-feedback-popup-email-text").html(
                    $("#feedback-popup-email-text").val().length + "/35"
                );
                $("#counter-for-feedback-popup-button-text").html(
                    $("#feedback-popup-button-text").val().length + "/35"
                );
                $("#counter-for-feedback-popup-thanks-text").html(
                    $("#feedback-popup-thanks-text").val().length + "/45"
                );

                $("#question-area").html(self.feedbackWidget.popup_header_text);
                $("#countly-feedback-comment-title").html(
                    self.feedbackWidget.popup_comment_callout
                );
                $("#countly-feedback-email-title").html(
                    self.feedbackWidget.popup_email_callout
                );
                $("#feedback-submit-button").html(
                    self.feedbackWidget.popup_button_callout
                );
                $(".success-emotions-area > #question-area").html(
                    self.feedbackWidget.popup_thanks_message
                );
                $("#feedback-sticker-on-window").html(
                    '<svg id="feedback-sticker-svg" aria-hidden="true" data-prefix="far" data-icon="grin" class="svg-inline--fa fa-grin fa-w-16" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512"><path id="path1" fill="white" d="M248 8C111 8 0 119 0 256s111 248 248 248 248-111 248-248S385 8 248 8zm0 448c-110.3 0-200-89.7-200-200S137.7 56 248 56s200 89.7 200 200-89.7 200-200 200zm105.6-151.4c-25.9 8.3-64.4 13.1-105.6 13.1s-79.6-4.8-105.6-13.1c-9.9-3.1-19.4 5.4-17.7 15.3 7.9 47.1 71.3 80 123.3 80s115.3-32.9 123.3-80c1.6-9.8-7.7-18.4-17.7-15.3zM168 240c17.7 0 32-14.3 32-32s-14.3-32-32-32-32 14.3-32 32 14.3 32 32 32zm160 0c17.7 0 32-14.3 32-32s-14.3-32-32-32-32 14.3-32 32 14.3 32 32 32z"></path></svg> ' +
                        self.feedbackWidget.trigger_button_text
                );
                ...
                $("#feedback-sticker-on-window").removeClass("bleft");
                $("#feedback-sticker-on-window").removeClass("bright");
                $("#feedback-sticker-on-window").addClass(
                    self.feedbackWidget.trigger_position
                );
                ...
                if (self.feedbackWidget.hide_sticker) {
                    $("#set-feedback-invisible-checkbox").removeClass(
                        "fa-square-o"
                    );
                    $("#set-feedback-invisible-checkbox").addClass(
                        "fa-check-square"
                    );
                } else {
                    $("#set-feedback-invisible-checkbox").removeClass(
            ...
            $("#create-feedback-widget-button").on("click", function() {
                if (
                    countlyGlobal.apps[store.get("countly_active_app")].type !==
                    "web"
                ) {
                    ...
                    $("#feedback-step1-title").css({
                        width: "50%",
                        "margin-left": "25%",
                        float: "left"
                    });
                    $(".feedback-step-desc").css({ color: "black" });
                    $("#feedback-step1-title").removeClass(
                        "feedback-active-step"
                    );
                ...
                $("#feedback-drawer-title").html(
                    jQuery.i18n.map["feedback.add-widget"]
                );
                self.feedbackWidget._id = "";
                self.feedbackWidget.popup_header_text =
                    jQuery.i18n.map["feedback.popup-header-text"];
                self.feedbackWidget.popup_comment_callout =
                    jQuery.i18n.map["feedback.popup-comment-callout"];
                self.feedbackWidget.popup_email_callout =
                    jQuery.i18n.map["feedback.popup-email-callout"];
                self.feedbackWidget.popup_button_callout =
                    jQuery.i18n.map["feedback.popup-button-callout"];
                self.feedbackWidget.popup_thanks_message =
                    jQuery.i18n.map["feedback.popup-thanks-message"];
                self.feedbackWidget.trigger_position = "mright";
                self.feedbackWidget.trigger_bg_color = "13B94D";
                self.feedbackWidget.trigger_font_color = "FFFFFF";
                self.feedbackWidget.trigger_button_text =
                    jQuery.i18n.map["feedback.trigger-button-text"];
                self.feedbackWidget.target_devices = {
                    phone: true,
                    desktop: true,
                    tablet: true
            ...
            $("body").on("click", ".edit-widget", function() {
                ...
                $("#feedback-drawer-title").html(
                    jQuery.i18n.map["feedback.edit-widget"]
                );
            ...
            $(".device-box").on("click", function() {
                ...
                self.feedbackWidget.target_devices[
                    $(this).data("target")
                ] = !self.feedbackWidget.target_devices[$(this).data("target")];
                // check toggled value
                if (
                    self.feedbackWidget.target_devices[$(this).data("target")]
                ) {
                ...
                if (
                    ...
                    if (!atLeastOneDevice) {
                        $("#countly-feedback-next-step").css({
                            display: "none"
                        });
                        CountlyHelpers.notify({
                            type: "error",
            ...
            $("#countly-feedback-set-feedback-active").on("click", function() {
                if (
                    $("#countly-feedback-set-feedback-active").data("state") ===
                    1
                ) {
                    $("#set-feedback-checkbox").removeClass("fa-check-square");
                    $("#set-feedback-checkbox").addClass("fa-square-o");
            ...
            $("#countly-feedback-set-sticker-invisible").on(
                "click",
                function() {
                    if (
                        $("#countly-feedback-set-sticker-invisible").data(
                            "state"
                        ) === 1
                    ) {
                        $("#set-feedback-invisible-checkbox").removeClass(
            ...
            $(".feedback-create-side-header-slice").on("click", function() {
                if (store.get("drawer-type") === "create") {
                    if (
                        parseInt($(this).data("step")) - parseInt(self.step) ===
                        1
                    ) {
            ...
            $("#countly-feedback-next-step").on("click", function() {
                ...
                if (self.step === 4) {
                    if (store.get("drawer-type") === "edit") {
                            ...
                            function(result, status) {
                                if (status === 200) {
                                    ...
                                    CountlyHelpers.notify({
                                        ...
                                        message:
                                            jQuery.i18n.map[
                                                "feedback.successfully-updated-message"
                                            ]
                                    });
                                    self.renderFeedbacksTable(true);
                                } else {
                        ...
                        $("#overlay").fadeIn();
                        starRatingPlugin.createFeedbackWidget(
                            self.feedbackWidget,
                            function(result, status) {
                                if (status === 201) {
                                    $(".cly-drawer").removeClass("open");
                                    ...
                                    CountlyHelpers.notify({
                                        ...
                                        message:
                                            jQuery.i18n.map[
                                                "feedback.successfully-created-message"
                                            ]
                                    });
                                    if (
                                        countlyGlobal.apps[
                                            store.get("countly_active_app")
                                        ].type === "web"
                                    ) {
                                        $("#feedback-web-integration").css({
                                            display: "block"
            ...
            var limitFieldLength = function(field, limit) {
                ...
                if (fieldLength > limit) {
                    ...
                    $("#countly-feedback-next-step").attr(
                        "disabled",
                        "disabled"
                    );
                } else {
                ...
                $("#counter-for-" + $(field).attr("id")).html(
                    Math.min(fieldLength, limit) + "/" + limit
                );
            };
            ...
            $("#feedback-trigger-text").on("keyup", function() {
                ...
                if ($(this).val() === "") {
                    ...
                    self.feedbackWidget.trigger_button_text = countlyCommon.encodeHtml(
                        $(this).val()
                    );
                    $("#feedback-sticker-on-window").html(
                        '<svg id="feedback-sticker-svg" aria-hidden="true" data-prefix="far" data-icon="grin" class="svg-inline--fa fa-grin fa-w-16" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512"><path id="path1" fill="white" d="M248 8C111 8 0 119 0 256s111 248 248 248 248-111 248-248S385 8 248 8zm0 448c-110.3 0-200-89.7-200-200S137.7 56 248 56s200 89.7 200 200-89.7 200-200 200zm105.6-151.4c-25.9 8.3-64.4 13.1-105.6 13.1s-79.6-4.8-105.6-13.1c-9.9-3.1-19.4 5.4-17.7 15.3 7.9 47.1 71.3 80 123.3 80s115.3-32.9 123.3-80c1.6-9.8-7.7-18.4-17.7-15.3zM168 240c17.7 0 32-14.3 32-32s-14.3-32-32-32-32 14.3-32 32 14.3 32 32 32zm160 0c17.7 0 32-14.3 32-32s-14.3-32-32-32-32 14.3-32 32 14.3 32 32 32z"></path></svg> ' +
            ...
            $("#feedback-popup-comment-text").on("keyup", function() {
                ...
                if ($(this).val() === "") {
                    ...
                    $("#countly-feedback-comment-title").text(
                        self.feedbackWidget.popup_comment_callout
                    );
                }
            });
            $("#feedback-popup-email-text").on("keyup", function() {
                ...
                if ($(this).val() === "") {
                    ...
                    $("#countly-feedback-email-title").text(
                        self.feedbackWidget.popup_email_callout
                    );
                }
            });
            ...
            $("#feedback-popup-thanks-text").on("keyup", function() {
                ...
                if ($(this).val().length > 45) {
                    ...
                    if ($(this).val() === "") {
                        ...
                        $(".success-emotions-area > #question-area").text(
                            self.feedbackWidget.popup_thanks_message
                        );
                    }
                }
            ...
            $("#set-feedback-active").on("change", function() {
                self.feedbackWidget.is_active = $(this).attr("checked")
                    ? true
                    : false;
            });
        }
    ...
    refresh: function() {
        ...
        $.when(
            ...
            starRatingPlugin.requestFeedbackData(self.ratingFilter.comments)
        ).done(function() {
